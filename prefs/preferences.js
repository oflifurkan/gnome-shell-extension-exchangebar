...
import {createProviderSettingsGroup} from './providerSettings.js';
...
export function fillPreferencesWindow(window, settings, metadata, _) {
    ...
    addPrecision(panelGroup, settings, 'currency-precision',
        _('Currency decimal places'), 6);
    addPrecision(panelGroup, settings, 'gold-precision',
        _('Gold decimal places'), 4);
    appearancePage.add(panelGroup);
    appearancePage.add(createProviderSettingsGroup(_));
